---
title: "Low Dimensional Example of MultiEFM"
author: "Wei Liu"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Low Dimensional Example of MultiEFM}
...
This vignette introduces the usage of MultiEFM for the analysis of low-dimensional multi-study multivariate data with heavy tail, by comparison with other methods.
...
```{r comp1, message=FALSE, warning=FALSE,eval =TRUE}
...
```{r comp2, message=FALSE, warning=FALSE,eval =TRUE}
print("MSFA-SVI")
tic <- proc.time()
...
```{r visua1, message=FALSE, warning=FALSE,eval =TRUE}
...
```{r visua2, message=FALSE, warning=FALSE, eval=TRUE, fig.width=10, fig.height=7}
library(cowplot)
library(ggplot2)
...
```{r sele, message=FALSE, warning=FALSE,eval =TRUE}
